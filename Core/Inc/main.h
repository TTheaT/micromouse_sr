...
#define RECIV_SR_Pin GPIO_PIN_5
#define RECIV_SR_GPIO_Port GPIOA
...
#define RECIV_SL_Pin GPIO_PIN_0
#define RECIV_SL_GPIO_Port GPIOB
...
#define EMIT_SL_Pin GPIO_PIN_11
